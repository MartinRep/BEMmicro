...
public class BemApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(BemApp.class);

    private final Environment env;

    public BemApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(BemApp.class);
